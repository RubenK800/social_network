                            ...
                            @if($independentcomment['receiver_comment_id'] === 0)
                                ...
                                <div class="bg-light">
                                    ...
                                    <div>
                                        @isset($independentcomment->image['image_name'])
                                            <img src="storage/comment_pics/{{$independentcomment->image['image_name']}}"
                                ...
                                <div>
                                    <button class="comment-like-dislike"
                                            data-comment-like-dislike="ind-c-like{{$independentcomment['id']}}">Like
                                    </button>
                                    <button class="comment-like-dislike"
                                            data-comment-like-dislike="ind-c-dislike{{$independentcomment['id']}}">
                                        Dislike
                                    </button>
                                    <button class="comment-function-show"
                                            data-comment-function-show="ind-reply{{$indElementNo}}">Reply
                                    </button>
                                    <div>
                                        @if($independentcomment->user['id'] === $userId)
                                            <button class="comment-edit" data-edit="ind-edit{{$indElementNo}}">Edit
                                            </button>
{{--                                            <form--}}
...
{{--                                            </form>--}}
                                ...
                                <div
                                    class="to-independent-comment-write-form ind-reply{{$indElementNo}}
                                        ind-changed-mind{{$indElementNo}}" hidden>
...
{{--                                                   class="comment-text reply-ind-c-value{{$indElementNo}}"--}}
{{--                                                   value="{{$independentcomment->user['name']}}, ">--}}
{{--                                        </label>--}}
{{--                                        <label style="border: solid #1a202c 1px">Add Image--}}
{{--                                            <input type="file" name="comment_image"--}}
{{--                                                   class="comment_image reply-ind-c-value{{$indElementNo}}" hidden>--}}
{{--                                        </label>--}}
{{--                                        <input type="submit" class="submit-comment"--}}
{{--                                               data-comment-value="reply-ind-c-value{{$indElementNo}}"--}}
{{--                                               value="Send comment">--}}
{{--                                    </form>--}}
                                    <button class="comment-function-hide"
                                            data-comment-function-hide="ind-changed-mind{{$indElementNo}}">I changed my
                                        mind
                                    </button>
                                </div>
                                ...
                                @if($independentcomment->user['id'] === $userId)
                                    <div
                                        class="independent-comment-edit-form ind-edit{{$indElementNo}}
                                            ind-edit-changed-mind{{$indElementNo}}" hidden>
                                        <div>write your new comment here. It will replace the old one above</div>
{{--                                        <form action="{{route('comments.update', ['id'=>$independentcomment['id']])}}"--}}
{{--                                              method='post' enctype='multipart/form-data'>--}}
{{--                                            @csrf--}}
{{--                                            @method('PUT')--}}
{{--                                            <label>--}}
{{--                                                <input type="text" name="comment-text"--}}
{{--                                                       class="comment-text edit-ind-c-value{{$indElementNo}}"--}}
{{--                                                       value="{{$independentcomment['comment_text']}}">--}}
{{--                                            </label>--}}
{{--                                            <label style="border: solid #1a202c 1px">Add Image--}}
{{--                                                <input type="file" name="comment_image"--}}
{{--                                                       class="comment_image edit-ind-c-value{{$indElementNo}}" hidden>--}}
{{--                                            </label>--}}
{{--                                            <input type="submit" class="submit-comment"--}}
{{--                                                   data-comment-value="edit-ind-c-value{{$indElementNo}}"--}}
{{--                                                   value="Send comment">--}}
{{--                                        </form>--}}
                                        <button class="comment-function-hide"
                                                data-comment-function-hide="ind-edit-changed-mind{{$indElementNo}}">I
                                            changed my mind
                                        </button>
                                    </div>
                                @endif
                            ...
                            <div class="ms-4">
                                @if(!is_null($independentcomment->dependentComments))
                                    @foreach($independentcomment->dependentComments as $dElementNo => $dependentComment)
                                        ...
                                        <div class="bg-light">
                                            ...
                                            <div>
                                                @isset($dependentComment->image['image_name'])
                                                    <img
                                                        src="storage/comment_pics/{{$dependentComment->image['image_name']}}"
                                                        alt="go away from me! I'm sad and angry" height="150px">
                                                @endisset
                                            </div>
                                        </div>
                                        <div>
                                            <button class="comment-like-dislike"
                                                    data-comment-like-dislike="d-c-like{{$dependentComment['id']}}">Like
                                            </button>
                                            <button class="comment-like-dislike"
                                                    data-comment-like-dislike="d-c-dislike{{$dependentComment['id']}}">
                                                Dislike
                                            </button>
                                            <button class="comment-function-show"
                                                    data-comment-function-show="d-reply{{$dElementNo}}">Reply
                                            </button>
                                            <div>
                                                @if($dependentComment->user['id'] === $userId)
                                                    <button class="comment-edit" data-edit="d-edit{{$dElementNo}}">
                                                        Edit
                                                    </button>
{{--                                                    <form--}}
{{--                                                        action="{{route('comments.destroy', ['id'=>$dependentComment['id']])}}"--}}
{{--                                                        method="post">--}}
{{--                                                        @method('DELETE')--}}
{{--                                                        @csrf--}}
{{--                                                        <input type="submit" value="Delete">--}}
{{--                                                    </form>--}}
                                        ...
                                        <div
                                            class="to-dependent-comment-write-form d-reply{{$dElementNo}}
                                                d-changed-mind{{$dElementNo}}"
                                            hidden>
{{--                                            <form action="{{route('comments.store', ['postId' => $post['id'],--}}
{{--                                            'receiverCommentId' => $independentcomment['id']])}}" method='post'--}}
{{--                                                  enctype="multipart/form-data">--}}
...
{{--                                                <label>--}}
{{--                                                    <input type="text" name="comment-text"--}}
{{--                                                           class="comment-text d-changed-mind{{$dElementNo}}"--}}
{{--                                                           value="{{$dependentComment->user['name']}}, ">--}}
{{--                                                </label>--}}
{{--                                                <label style="border: solid #1a202c 1px">Add Image--}}
{{--                                                    <input type="file" name="comment_image"--}}
{{--                                                           class="comment_image d-changed-mind{{$dElementNo}}" hidden>--}}
{{--                                                </label>--}}
{{--                                                <input type="submit" class="submit-comment"--}}
{{--                                                       data-comment-value="d-changed-mind{{$dElementNo}}"--}}
{{--                                                       value="Send comment">--}}
{{--                                            </form>--}}
                                            <button class="comment-function-hide"
                                                    data-comment-function-hide="d-changed-mind{{$dElementNo}}">I changed
                                                my mind
                                            </button>
                                        </div>

{{--                                        даже если кнопка Edit видна для не авторизованного пользователя, то нажатие на
                                        него не активирует окно comment edit--}}
                                        @if($dependentComment->user['id'] === $userId)
                                            <div
                                                class="dependent-comment-edit-form d-edit{{$dElementNo}}
                                                    d-edit-changed-mind{{$dElementNo}}"
                                                hidden>
                                                <div>write your new comment here. It will replace the old one above
                                                </div>
{{--                                                <form--}}
{{--                                                    action="{{route('comments.update', ['id'=>$dependentComment['id']])}}"--}}
{{--                                                    method='post' enctype='multipart/form-data'>--}}
{{--                                                    @csrf--}}
{{--                                                    @method('PUT')--}}
{{--                                                    <label>--}}
{{--                                                        <input type="text" name="comment-text"--}}
{{--                                                               class="comment-text edit-d-c-value{{$dElementNo}}"--}}
{{--                                                               value="{{$dependentComment['comment_text']}}">--}}
{{--                                                    </label>--}}
{{--                                                    <label style="border: solid #1a202c 1px">Add Image--}}
{{--                                                        <input type="file" name="comment_image"--}}
{{--                                                               class="comment_image edit-d-c-value{{$dElementNo}}"--}}
{{--                                                               hidden>--}}
{{--                                                    </label>--}}
{{--                                                    <input type="submit" class="submit-comment"--}}
{{--                                                           data-comment-value="edit-d-c-value{{$dElementNo}}"--}}
{{--                                                           value="Send comment">--}}
{{--                                                </form>--}}
                                                <button class="comment-function-hide"
                                                        data-comment-function-hide="d-edit-changed-mind{{$dElementNo}}">
                                                    I changed my mind
                                                </button>
                                            </div>
                                        @endif
                    ...
                    <hr>
                    <div>
{{--                        <form action="{{route('comments.store', ['postId' => $post['id'], 'receiverCommentId' => 0])}}"--}}
{{--                              method='post' enctype="multipart/form-data">--}}
{{--                            @csrf--}}
{{--                            <label>--}}
...
{{--                            </label>--}}
{{--                            <input type="submit" class="submit-comment" data-comment-value="c-value{{$postNo}}"--}}
{{--                                   value="Send comment">--}}
{{--                        </form>--}}
                    </div>
                    <hr>
